...
namespace Ej4
{
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        public MainWindow()
        {
            ...
            {
                new Product { Name = "portatil", Price = "$999", ImageSource = "Imagen/portatil.png" },
                new Product { Name = "raton", Price = "$20", ImageSource = "Imagen/raton.png" },
                new Product { Name = "teclado", Price = "$50", ImageSource = "Imagen/teclado.png" }
            };
